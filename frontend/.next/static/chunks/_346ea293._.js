...
"[project]/src/app/admin/attendance/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AdminAttendancePage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminAttendancePage.useEffect": ()=>{
            const fetchData = {
                "AdminAttendancePage.useEffect.fetchData": async ()=>{
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5000/api")}/attendance/all`, {
                        withCredentials: true
                    });
                    console.log(res.data, 'users');
                    setAttendanceData(res.data);
                }
            }["AdminAttendancePage.useEffect.fetchData"];
            fetchData();
        }
    }["AdminAttendancePage.useEffect"], []);
...
_s(AdminAttendancePage, "dwuTqIp2CzfVFy6F0f7BHj0/jnA=");
...
//# sourceMappingURL=_346ea293._.js.map